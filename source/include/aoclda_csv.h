 ...
 * row */
da_status da_read_csv_d(da_csv_opts opts, char *filename, double **a, size_t *nrows,
                        size_t *ncols);

da_status da_read_csv_s(da_csv_opts opts, char *filename, float **a, size_t *nrows,
                        size_t *ncols);

da_status da_read_csv_int64(da_csv_opts opts, char *filename, int64_t **a, size_t *nrows,
                            size_t *ncols);

da_status da_read_csv_uint64(da_csv_opts opts, char *filename, uint64_t **a,
                             size_t *nrows, size_t *ncols);

da_status da_read_csv_uint8(da_csv_opts opts, char *filename, uint8_t **a, size_t *nrows,
                            size_t *ncols);

da_status da_read_csv_d_h(da_csv_opts opts, char *filename, double **a, size_t *nrows,
                          size_t *ncols, char ***headings);

da_status da_read_csv_s_h(da_csv_opts opts, char *filename, float **a, size_t *nrows,
                          size_t *ncols, char ***headings);

da_status da_read_csv_int64_h(da_csv_opts opts, char *filename, int64_t **a,
                              size_t *nrows, size_t *ncols, char ***headings);

da_status da_read_csv_uint64_h(da_csv_opts opts, char *filename, uint64_t **a,
                               size_t *nrows, size_t *ncols, char ***headings);

da_status da_read_csv_uint8_h(da_csv_opts opts, char *filename, uint8_t **a,
                              size_t *nrows, size_t *ncols, char ***headings);
