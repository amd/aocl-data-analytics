...
add_custom_target(create_cov_dir
COMMAND ${CMAKE_COMMAND} -E make_directory
                                             ${COV_DIR})

# create coverage target for ctest
# make coverage will run ctest and build a report in the build directory
add_custom_target(
  coverage
...
# function to build a coverage report from a set of executable names
#      argument: string containing a list of all executables to run
# - runs all the executables in ARGN
# - generate an htm gcovr report in ${COV_DIR
