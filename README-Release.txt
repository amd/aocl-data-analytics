...
1. You will need either:
   * a Visual Studio installation and comopatible Fortran compiler (this will allow you to build with cl or with the MSVC compatibility layer for clang (clang-cl)).
